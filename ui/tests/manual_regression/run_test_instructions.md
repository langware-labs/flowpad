...
### General Tests (1 file, 6 test cases)

| File | Test Cases | What It Tests |
|------|-----------|---------------|
| `heartbeat_sniffer_hook_events_e2e.md` | 6 | Sniffer activation/deactivation, webhook listen endpoint, real Claude CLI events on heartbeat, event list & detail view, listen no-hang regression |
