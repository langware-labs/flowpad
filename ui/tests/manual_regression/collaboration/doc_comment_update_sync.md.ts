...
import {
  ALICE_API, BOB_API, cleanup, editComment, mkComment, newRig, rigUnavailable,
  setupSharedConversation, waitText, type Rig,
} from './_doc_comment_collab';

test('binding criterion: editing a comment syncs the new text [doc_comment_update_sync]', async () => {
