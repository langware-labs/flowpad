...
import { ALICE_API, BOB_API, mkComment, rmComment, waitAbsent, waitText, withSharedConversation } from './_doc_comment_collab';

test('binding criterion: present on BOTH sides, then removed for the peer [doc_comment_delete_sync]', withSharedConversation(async (rq, { convId }) => {
