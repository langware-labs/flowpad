 ...
 *  which is the one place a person is choosing between them. */
export const CloudMailboxIcon = ((props: React.SVGProps<SVGSVGElement>) => (
  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8"
       strokeLinecap="round" strokeLinejoin="round" aria-hidden="true" {...props}>
    <path d="M17.5 8.2a5 5 0 0 0-9.6-1.6A3.6 3.6 0 0 0 7.4 13" />
    <rect x="3" y="12.5" width="18" height="8" rx="1.6" />
    <path d="m3.6 13.3 7.5 4.3a1.8 1.8 0 0 0 1.8 0l7.5-4.3" />
  </svg>
