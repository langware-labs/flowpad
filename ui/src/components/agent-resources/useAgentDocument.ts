 ...
 *    file, so it stays editable instead of rendering dead checkboxes.
 *
...
export function useAgentDocument(): AgentDocument {
  ...
  return { ready: !!mainRef && source !== undefined, isLoading: !!mainRef && isLoading, list, commit };
}
