...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Overlay
    ref={ref}
    className={cn(
      // will-change-transform + isolate force the overlay onto its own composited
...
interface DialogContentProps extends React.ComponentPropsWithoutRef<typeof DialogPrimitive.Content> {
  /**
   * Drop the corner close (X). For dialogs whose own toolbar already carries a
   * Cancel action — the corner X would be a second dismiss control and, on a
