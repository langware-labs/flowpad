...
interface ActivationRuleViewProps {
  content: string;
  onChange: (content: string) => void;
}

export function ActivationRuleView({ content, onChange }: ActivationRuleViewProps) {
  ...
  return (
    <div className="flex h-full flex-col">
      <div className="flex h-8 items-center border-b bg-muted/30 px-3">
        <span className="text-xs text-muted-foreground">rule.md</span>
      </div>
