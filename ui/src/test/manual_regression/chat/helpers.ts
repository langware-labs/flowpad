...
export async function waitForLanding(page: Page) {
  // Use a CSS/text selector instead of getByRole — while a Radix AlertDialog is open it
  // sets aria-hidden="true" on the rest of the page, causing getByRole('heading') to
