"""
Lexical type definitions.

This module contains all TypedDict definitions for Lexical editor node types.
"""
...
class LexicalLabelHeadingNode(TypedDict):
    type: Literal["label-heading"]
    version: Literal[1]
    children: list[LexicalNode]
    labels: list[str]
    tag: NotRequired[str]
