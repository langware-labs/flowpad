...
draws none and leaves exactly Send and Cancel. Send answers ``{}``; Cancel is
the ask op's own ``cancelled`` answer. There is no ``yes: bool`` field, because
a field would be a text box a person could type ``false`` into and still send.
"""
