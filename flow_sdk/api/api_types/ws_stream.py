...
# TODO: InMemoryCache not available locally, creating stub implementations
class InMemoryCacheConfig:
    """Stub implementation of InMemoryCacheConfig"""
    def __init__(self, default_ttl=3600, reset_ttl_on_get=True):
        self.default_ttl = default_ttl
        self.reset_ttl_on_get = reset_ttl_on_get

class InMemoryCache:
    """Stub implementation of InMemoryCache"""
