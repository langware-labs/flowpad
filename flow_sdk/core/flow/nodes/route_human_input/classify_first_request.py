"""First request classification for initial user prompts."""
...
FIRST_REQUEST_CLASSIFICATION_PROMPT = """## First Request Classification

Analyze the user's FIRST request and classify the mode.
...
async def classify_first_request(user_prompt: str, context: str = "") -> RequestClassification:
    """Classify mode in a single LLM request using JSON mode."""
    try:
        instruction = FIRST_REQUEST_CLASSIFICATION_PROMPT.format(
