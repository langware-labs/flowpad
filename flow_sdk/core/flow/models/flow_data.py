"""Flow data structures for streaming LLM responses."""
...
class FlowData(BaseModel):
    ...
    focus: Optional[str] = None  # Focus recommendation for UI (e.g., "editor", "shell", "chat")
...
class FlowCheckpointData(FlowData):
    ...
    def create(cls, checkpoint_hash: str) -> "FlowCheckpointData":
        ...
        return cls(
            flow_value="",
            attributes={
                "element-type": FlowElementType.CHECKPOINT.value,
