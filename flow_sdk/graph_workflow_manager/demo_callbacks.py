"""Built-in demo GraphWorkflowFunctions for flow prototyping.

Registered on import (graph_workflow_manager/__init__ pulls this in). A function's dict
...
@graph_workflow_functions.register("flow_echo", meaning="flow demo: log the delivered event")
...
@graph_workflow_functions.register("flow_relay", meaning="flow demo: pass data onward with a hop counter")
