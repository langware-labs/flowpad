...
The indexer syncs one row per process_runner/pysdk node, attached as a CHILD
...
class FlowNode(Entity):
    ...
    node_type: str = APIField(default="process_runner", description="trigger | process_runner | pysdk")
