...
from flow_sdk.assets.types.graph_workflow_doc import GraphWorkflowDoc, parse_graph_workflow_doc
...
def graph_workflow_asset_hash(ref: FSRef) -> float:
...
def extract_graph_workflow(ref: FSRef, resolved_id: str) -> list[FSRecord]:
    ...
    rec_kwargs: dict = {
        "type": RecordType.GRAPH_WORKFLOW,
        "id": resolved_id,
        "name": name,
        "status": "active",
        "content": content,
