---
id: f41ce127-2708-4aa0-9c05-312e6c08894b
---
# 0.2.173 — the open slot
...
script when 0.2.172 is cut; do not hand-author it.
...
A migration written here ships in the 0.2.173 wheel and runs on upgrade to it.
...
If this slot is still empty when 0.2.173 is released, the release script
