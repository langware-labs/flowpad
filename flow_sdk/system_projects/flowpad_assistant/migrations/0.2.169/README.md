---
id: 87b20290-c2ab-461d-9cbb-5cd08cc5e75f
---
# 0.2.169 — the open slot

This directory is the next UNRELEASED recipe version: the only place a new
migration can be added and still be reached. It is created by
`scripts/rotate_migration_slot.sh` when 0.2.168 is cut; do not hand-author it.
...
A migration written here ships in the 0.2.169 wheel and runs on upgrade to it.
...
If this slot is still empty when 0.2.169 is released, the release script
