---
id: 2d39d621-3f29-4c47-a677-71a4b497926d
---
# 0.2.175 — the open slot
...
script when 0.2.174 is cut; do not hand-author it.
...
A migration written here ships in the 0.2.175 wheel and runs on upgrade to it.
...
If this slot is still empty when 0.2.175 is released, the release script
