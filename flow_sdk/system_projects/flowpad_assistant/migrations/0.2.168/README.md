...
`scripts/rotate_migration_slot.sh` when 0.2.167 is cut; do not hand-author it.
...
A migration written here ships in the 0.2.168 wheel and runs on upgrade to it.
...
If this slot is still empty when 0.2.168 is released, the release script
