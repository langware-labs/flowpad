"""0.2.154 — the reachable home for the next migration. Does nothing yet.
...
until someone opens the next one. This is that directory, opened as part of
the release rather than left for the next person to trip over.
