---
id: b0dee4c6-4a9f-429a-85a1-87931f2812d1
---

# 0.2.165 — the open slot
...
script when 0.2.164 is cut; do not hand-author it.
...
A migration written here ships in the 0.2.165 wheel and runs on upgrade to it.
...
If this slot is still empty when 0.2.165 is released, the release script
