...
> Last updated: 2026-07-13T20:58:40Z
> Scope: every category-level `.md` scenario and `.md.ts` Playwright file under `ui/tests/manual_regression/`; `_results/` and `_fast_paths/` are excluded from scenario totals.
> Test counts come from `test N:` blocks or the spec's explicit case labels (`S1`, `VIBE-001`, and similar); single-flow specs fall back to one. Spec-less files use Playwright `test(...)` declarations.

## agentic-process (14 specs, 15 Playwright files; config: yes)

| Scenario | Tests | Playwright | Fast Path | Skip |
|---|---:|---|---|---|
| `codex_chat_terminal_full_matrix.md` | 27 | no | no | - |
| `codex_chat_terminal_switch_matrix.md` | 16 | no | no | - |
...
| `resume_session_from_recent.md` | 3 | yes | no | - |
| `session_info_popover.md` | 3 | yes | no | clipboard |
| `worktree_lifecycle.md` | 3 | yes | no | - |
| `_resume_revalidate_v3.md.ts` *(no sibling spec)* | 1 | yes (spec missing) | no | embedded test.skip |
| `agentic_process_visible_restored_on_load.md.ts` *(no sibling spec)* | 1 | yes (spec missing) | no | - |
| `quick_create_session_browser_url_order.md.ts` *(no sibling spec)* | 1 | yes (spec missing) | no | - |
| `shell_url_recovers_linked_process.md.ts` *(no sibling spec)* | 1 | yes (spec missing) | no | - |

## assets (3 specs, 3 Playwright files; config: yes)

| Scenario | Tests | Playwright | Fast Path | Skip |
|---|---:|---|---|---|
| `agent_execution_asset_picker.md` | 8 | yes | no | - |
| `assets_list_mode.md` | 6 | yes | no | - |
| `wiki_folder_tree.md` | 16 | yes | no | - |

## chat (14 specs, 14 Playwright files; config: yes)
...
## cli-log (1 specs, 1 Playwright files; config: yes)

| Scenario | Tests | Playwright | Fast Path | Skip |
|---|---:|---|---|---|
| `cli_log_viewer.md` | 3 | yes | yes | - |

## collaboration (7 specs, 7 Playwright files; config: yes)
...
## conversation (2 specs, 2 Playwright files; config: yes)
...
## editor (13 specs, 13 Playwright files; config: yes)
...
## general (7 specs, 7 Playwright files; config: yes)
...
## k_browser (1 specs, 1 Playwright files; config: yes)

| Scenario | Tests | Playwright | Fast Path | Skip |
|---|---:|---|---|---|
| `atlas_status_and_diff.md` | 5 | yes | no | - |

## markdown_index (1 specs, 1 Playwright files; config: yes)

| Scenario | Tests | Playwright | Fast Path | Skip |
|---|---:|---|---|---|
| `smoke.md` | 11 | yes | no | - |

## search (8 specs, 8 Playwright files; config: yes)

| Scenario | Tests | Playwright | Fast Path | Skip |
|---|---:|---|---|---|
| `mcp_index.md` | 5 | yes | no | - |
| `rebuild_index_ui.md` | 11 | yes | no | - |
| `record_search_from_home.md` | 3 | yes | no | - |
| `record_search_view.md` | 4 | yes | yes | - |
| `scan_records_viewer.md` | 6 | yes | no | - |
| `search_bar.md` | 6 | yes | no | - |
| `search_limit_param.md` | 1 | yes | no | - |
| `search_scan_info_stats.md` | 6 | yes | no | - |

## setup (1 specs, 1 Playwright files; config: yes)

| Scenario | Tests | Playwright | Fast Path | Skip |
|---|---:|---|---|---|
| `llm_not_configured_shows_up_after_configuring_llm.md` | 2 | yes | no | - |

## skills (6 specs, 7 Playwright files; config: yes)
...
| `full_analysis_flow.md.ts` *(no sibling spec)* | 1 | yes (spec missing) | no | - |

## sniffer (4 specs, 4 Playwright files; config: yes)
...
## tab_management (0 specs, 2 Playwright files; config: yes)

| Scenario | Tests | Playwright | Fast Path | Skip |
|---|---:|---|---|---|
| `tab_lifecycle.md.ts` *(no sibling spec)* | 5 | yes (spec missing) | no | - |
| `tab_reorder.md.ts` *(no sibling spec)* | 1 | yes (spec missing) | no | - |

## terminal (26 specs, 31 Playwright files; config: yes)

| Scenario | Tests | Playwright | Fast Path | Skip |
|---|---:|---|---|---|
| `ctrlc_doesnt_copy_in_shell_tab.md` | 1 | yes | no | clipboard |
| `flow_shell_tab_location.md` | 1 | yes | no | - |
| `git_status_panel.md` | 10 | yes | no | - |
| `in_claude_ctrlv_does_not_paste.md` | 1 | yes | no | clipboard |
| `interactive_tabs_project_filtering_matrix.md` | 52 | yes | no | platform, live-claude, clipboard, harness |
| `multiple_terminal_tabs.md` | 1 | yes | no | - |
| `navigate_to_shell.md` | 1 | yes | no | - |
| `prompt_index_panel.md` | 12 | yes | no | - |
...
| `terminal_annotation_bookmark.md` | 5 | yes | no | - |
...
| `time_gutter_and_prompt_annotations.md` | 10 | yes | no | - |
...
| `debug_nav.md.ts` *(no sibling spec)* | 1 | yes (spec missing) | no | - |
| `dir_panel_scroll.md.ts` *(no sibling spec)* | 1 | yes (spec missing) | no | - |
| `plain_shell_url_loads_silently.md.ts` *(no sibling spec)* | 1 | yes (spec missing) | no | - |
| `shell_tab_title_and_switch.md.ts` *(no sibling spec)* | 1 | yes (spec missing) | no | - |
| `terminal_tab_switch_no_duplicates.md.ts` *(no sibling spec)* | 1 | yes (spec missing) | no | - |

## triggers (1 specs, 5 Playwright files; config: yes)

| Scenario | Tests | Playwright | Fast Path | Skip |
|---|---:|---|---|---|
| `trigger_process_target_typeid_str.md` | 1 | yes | no | - |
| `cron_view_redirects_to_triggers.md.ts` *(no sibling spec)* | 1 | yes (spec missing) | no | - |
| `hook_trigger_still_works.md.ts` *(no sibling spec)* | 1 | yes (spec missing) | no | - |
| `schedule_trigger_create_edit.md.ts` *(no sibling spec)* | 1 | yes (spec missing) | no | embedded test.skip |
| `schedule_trigger_fires_test.md.ts` *(no sibling spec)* | 1 | yes (spec missing) | no | embedded test.skip |

## vibe (2 specs, 0 Playwright files; config: no)

| Scenario | Tests | Playwright | Fast Path | Skip |
|---|---:|---|---|---|
| `vibe_bugs.md` | 7 | no | no | - |
| `vibe_workspace_matrix.md` | 14 | no | no | - |

## whiteboard (8 specs, 8 Playwright files; config: yes)

| Scenario | Tests | Playwright | Fast Path | Skip |
|---|---:|---|---|---|
| `create_persist.md` | 5 | yes | no | - |
...
## workflow (2 specs, 2 Playwright files; config: yes)
...
- Markdown specs: 121
- Playwright files: 132
- Specs without sibling Playwright: 5
- Playwright files without sibling spec: 16
- Fast paths: 2
