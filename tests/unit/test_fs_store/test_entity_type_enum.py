...
EXPECTED = {
    "PROJECT": "project", "CLAUDE_SESSION": "claude_session", "TASK": "task",
    "RULE": "rule", "SKILL": "skill", "AGENT": "agent", "LOG": "log",
    "AGENTIC_PROCESS": "agentic_process", "ARTIFACT": "artifact", "BOOKMARK": "bookmark",
    "ANNOTATION": "annotation", "COMMENT": "comment", "APP_SECRET": "app_secret",
    "CLAUDE_ROOT": "claude_root", "ACCOUNT": "account", "HOOK": "hook",
    "HOOK_ENTRY": "hook_entry", "CLAUDE_HOOK": "claude_hook",
    "CLAUDE_HOOK_SOURCE": "claude_hook_source", "TODO_FILE": "todo_file",
    "TODO_ITEM": "todo_item", "PLAN": "plan", "CLAUDE_MEMORY": "claude_memory",
    "CLAUDE_RULES": "claude_rules", "COMMAND": "command", "MCP_SERVER": "mcp_server",
    "MCP_SERVER_SOURCE": "mcp_server_source",
    "PLUGIN": "plugin", "CLAUDE_MD": "claude_md", "HISTORY": "history",
    "HISTORY_ENTRY": "history_entry", "TRANSCRIPT_ENTRY": "transcript_entry",
    ...
    "TRANSCRIPT_PR_LINK": "transcript_entry:pr_link", "COMPUTE_NODE": "compute_node",
    "ENVIRONMENT": "environment", "SESSION_ANALYSIS": "session_analysis",
    "SESSION_CLASSIFICATION": "session_classification", "ACTIVE_SESSIONS": "active_sessions",
    "ACTIVE_SESSION": "active_session", "SHELL": "shell",
    "CLAUDE_DEBUG_LOG": "claude_debug_log", "CLAUDE_ERROR": "claude_error",
    "CLAUDE_SETTINGS": "claude_settings", "CLAUDE_SETTINGS_OAUTH": "claude_settings:oauth_account",
    ...
    "APP_HOST": "app_host", "TEAM": "team", "GROUP": "group", "ORGANIZATION": "organization",
    "WORKSPACE": "workspace", "PAGE": "page", "FLOW": "flow", "INVITATION": "invitation",
    "MENTION": "mention", "CONNECTION": "connection", "EXTENSION": "extension", "FUNC": "func",
    "SYNC_SERVICE": "sync_service", "PLUGIN_MANIFEST": "plugin_manifest",
    "FLOWPAD_SERVICE": "flowpad_service", "STORAGE": "storage_device", "FLOW_FILE": "flow_file",
