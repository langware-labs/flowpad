...
@pytest.mark.asyncio
async def test_ensure_live_compute_node_binding_rebinds_prefixed_stale_node_to_local():
    """Stale shell bindings should rebind to the current @local compute node."""
