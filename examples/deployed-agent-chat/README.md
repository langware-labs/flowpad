...
It uses the existing `Agent`, `AgenticProcess`, `FlowDataStream`, `ActionInfo`, and `dataManager` exports. The page supports Hub login, a new session, reconnect, transcript reload, live FlowData streaming, status, and cancellation.
