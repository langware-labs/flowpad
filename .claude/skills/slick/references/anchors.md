...
| Server-side derived state (don't recompute in FE) | `flow_sdk/core/entity/entity_model.py` | `Entity.private_context_entities` (computed\_field) |
...
| TypeInfo class    | `flow_sdk/fs_store/schema_registry.py`               | `TypeInfo` (icon, meta\_model, post\_sync\_fn, …)         |
