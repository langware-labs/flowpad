...
- `capsules` / `identity_carrier` — named capsule declarations plus WHERE the id lives (`Frontmatter` / `Sidecar` / `JsonRoot` / `Derived`, `flow_sdk/fs_store/identity_carrier.py`)
