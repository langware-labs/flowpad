...
- [Desktop install — test scenarios](desktop-install-test-scenarios.md) — Desktop install test scenarios: Python pin read from pyproject, retryable failed-install panel, clean-room uv tool install release gate, and post-release regression checks.
