...
- [Credentials and secrets](secret_share.md) — Credentials (SecretPack) as the only secret declaration: user and project scope, the .env.local and vault stores, resolution and precedence, and the credentials operations.
