...
params:
  ...
  cli_options: "property -> WorkerCLIOptions"
...
params:
  ...
  load_embedded_agent: "(agent) -> void"
...
params:
  ...
  load-embedded-agent: "POST {asset_ref} -> loaded agent"
...
params:
  ...
  cliOptions: "getter/setter -> ClaudeCliOptions"
...
params:
  ...
  loadEmbeddedAgent: "async (sourcePath) -> void"
